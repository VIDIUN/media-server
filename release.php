<?php
require_once(__DIR__ . '/VidiunWowzaServer/build/tmp/github-php-client/GitHubClient.php');
...
$jars = glob(__DIR__ . "/VidiunWowzaServer/build/tmp/artifacts/Vidiun*.jar");
foreach ($jars as $jar) {
    uploadAsset($client, $jar, $owner, $repo, $releaseId,'application/java-archive');
}

//upload the zip distribution
$filePath = __DIR__ . "/VidiunWowzaServer/build/distributions/VidiunWowzaServer-install-$version.zip";
